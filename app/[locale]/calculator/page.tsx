...
export default function CalculatorPage() {
  ...
  const handleCalculate = () => {
    const result = calculateEstimate({
      ...
      supportHours: (supportHours === 'custom' ? customHours : supportHours) as any
    })
    setEstimate(result)
            ...
            <CardContent>
              ...
              {step === 2 && isMonthlySupport && (
                <div className="space-y-4">
                  ...
                  {[
                    { key: '10', label: '10h', desc: t('step_support.10h_desc'), price: 'R$ 1.500/mes' },
                    { key: '20', label: '20h', desc: t('step_support.20h_desc'), price: 'R$ 2.800/mes' },
                    { key: '40', label: '40h', desc: t('step_support.40h_desc'), price: 'R$ 5.200/mes' },
                  ...
                  {supportHours === 'custom' && (
                    <div className="mt-4 space-y-2">
                      <label htmlFor="customHours" className="text-sm font-medium">{t('step_support.custom_hours_label')}</label>
                      <Input
                        id="customHours"
                        type="number"
                        min="1"
                ...
                <div className="space-y-6">
                  <div className="rounded-xl bg-gradient-to-r from-[rgb(var(--primary))]/20 to-[rgb(var(--secondary))]/20 p-8 text-center">
                    ...
                    <div className="text-4xl font-bold gradient-text">
                      {isMonthlySupport 
                        ? `${formatCurrency(estimate.min, locale)}/mes`
